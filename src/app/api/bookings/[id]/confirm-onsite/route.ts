...
export async function POST(
  ...
  if (error) {
    console.error('[confirm-onsite]', error.message)
  ...
  const [clientNotif, salonNotif] = await Promise.all([
    sendWhatsApp(clientWhatsapp, confirmMsg),
    sendWhatsApp(b.salons.phone_whatsapp ?? '', alertMsg),
  ])
